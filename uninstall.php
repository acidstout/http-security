...
unregister_setting( 'http-security', 'http_security_feature_policy_flag' );
unregister_setting( 'http-security', 'http_security_feature_policy_autoplay' );
unregister_setting( 'http-security', 'http_security_feature_policy_camera' );
unregister_setting( 'http-security', 'http_security_feature_policy_document_domain' );
unregister_setting( 'http-security', 'http_security_feature_policy_encrypted_media' );
unregister_setting( 'http-security', 'http_security_feature_policy_fullscreen' );
unregister_setting( 'http-security', 'http_security_feature_policy_geolocation' );
unregister_setting( 'http-security', 'http_security_feature_policy_microphone' );
unregister_setting( 'http-security', 'http_security_feature_policy_midi' );
unregister_setting( 'http-security', 'http_security_feature_policy_payment' );
unregister_setting( 'http-security', 'http_security_feature_policy_vr' );
